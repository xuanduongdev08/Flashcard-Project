...
<div class="max-w-3xl mx-auto px-4 animate-fade-in pb-20">
    <div class="mb-10 flex flex-col items-center text-center">
        ...
        <h1 class="text-3xl font-black text-white mb-2 leading-snug tracking-tighter">Cập nhật thông tin bộ thẻ</h1>
        <p class="text-slate-500 font-medium">Chỉnh sửa tên, ngôn ngữ hoặc mô tả cho bộ sưu tập của bạn.</p>
    </div>

    <form action="{{ route('decks.update', $deck) }}" method="POST" class="bg-slate-900 shadow-2xl border border-slate-800 p-8 md:p-12 rounded-3xl space-y-8">
        @csrf @method('PUT')
